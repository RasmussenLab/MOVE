...
def visualize_recon_acc(nLayers, nHiddens, nDropout, nBeta, nLatents, recon_acc, data_type):
...
def visualize_embedding(data_type, feature_of_interest, embedding, mask, cat_list, 
                        con_list, cat_names, con_names):
