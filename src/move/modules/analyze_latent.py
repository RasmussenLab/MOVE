...
#                 config_types=['data', 'model', 'training_latent'])
    ...
    features_to_visualize = cfg.data_cfg.data_features_to_visualize_notebook4
    ...
    nHiddens = cfg.latent_cfg.num_hidden
    nLatents = cfg.latent_cfg.num_latent
    nLayers = cfg.latent_cfg.num_layers
    nDropout = cfg.latent_cfg.dropout
    nBeta = cfg.latent_cfg.beta
    batch_sizes = cfg.latent_cfg.batch_sizes
    nepochs = cfg.latent_cfg.tuned_num_epochs 
