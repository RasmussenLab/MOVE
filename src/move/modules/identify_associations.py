...
#                         config_types=['data', 'model', 'training_association'])
    ...
    up_down_list = cfg.data_cfg.write_omics_results_notebook5
    ...
    nHiddens = cfg.association_cfg.num_hidden
    nLatents = cfg.association_cfg.num_latent
    nLayers = cfg.association_cfg.num_layers
    nDropout = cfg.association_cfg.dropout
    nBeta = cfg.association_cfg.beta
    batch_sizes = cfg.association_cfg.batch_sizes
    nepochs = cfg.association_cfg.tuned_num_epochs
    repeats = cfg.association_cfg.repeats
