...
def analyze_latent_multiprocess(config: MOVEConfig) -> None:
    ...
    output_path = Path(config.data.results_path) / "latent_space_multiprocess"
    ...
    if model_path.exists():
        logger.debug(f"Re-loading model from {model_path}")
    ...
    # START WITH IMPORTANCE FOR CATEGORICAL FEATURES.
