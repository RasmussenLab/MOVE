...
class FindAssociations(CsvWriterMixin, Task):
    """Find associations after a perturbation.

    Associations are identified using either Bayes factors or Bayesian t-tests.
    """

    filename_fmt = "associations_{}.csv"
