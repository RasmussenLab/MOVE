...
from move.data.perturbations import perturb_categorical_data, perturb_continuous_data_extended
...
def identify_associations(config: MOVEConfig):
    """Leads to the execution of the appropiate association 
...
def identify_associations_categorical(config: MOVEConfig):
    """Trains multiple models to identify associations between the 
    categrorical dataset of interest and the continuous datasets."""
...
def identify_associations_continuous(config: MOVEConfig):
    """Trains multiple models to identify associations between the dataset
    of interest, containing continuous data, and the other continuous datasets."""
