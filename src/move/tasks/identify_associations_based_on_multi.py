...
###############################################################################
# THIS IS THE SCRIPT THAT IS COPIED INTO IDENTIFY_ASSOCIATIONS.PY NOW
###############################################################################
...
def _bayes_approach(
    ...
    # Here we will stor the important results:
    ...
    for i in range(num_perturbed):
        ...
        for j in range(task_config.num_refits):
            ...
            logger.debug(f"Returning mean_diff for feature {i}")
