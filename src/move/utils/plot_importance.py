...
red_blue = LinearSegmentedColormap(
    "red_blue",
    {  # #1E88E5 -> #ff0052
        "red": ((0.0, 30.0 / 255, 30.0 / 255), (1.0, 255.0 / 255, 255.0 / 255)),
        "green": ((0.0, 136.0 / 255, 136.0 / 255), (1.0, 13.0 / 255, 13.0 / 255)),
        "blue": ((0.0, 229.0 / 255, 229.0 / 255), (1.0, 87.0 / 255, 87.0 / 255)),
...
def summary_plot(
    ...
    color_bar=True,
    auto_size_plot=True,
    layered_violin_max_num_bins=50,
    class_names=None,
    size=10,
):
    ...
    if plot_type == "dot":
                ...
                for i in range(len(xs) - 1):
                    if ds[i] > 0.05 or ds[i + 1] > 0.05:
                        pl.fill_between(
                            ...
                            [pos + ds[i], pos + ds[i + 1]],
                            [pos - ds[i], pos - ds[i + 1]],
                            color=red_blue_solid(smooth_values[i]),
                            zorder=2,
                        )
        ...
        for i, ind in enumerate(class_inds):
            ...
            pl.barh(
                ...
                left=left_pos,
                align="center",
                color=default_blue_colors[min(i, len(default_blue_colors) - 1)],
    ...
    if (
        ...
        m = cm.ScalarMappable(
            cmap=red_blue_solid if plot_type != "layered_violin" else pl.get_cmap(color)
        )
        m.set_array([0, 1])
